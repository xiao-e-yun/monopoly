...
export const bindGameRender = (canvas: HTMLCanvasElement) => gameRenderInner = new GameRender2(canvas)
  ;
let gameRenderInner: GameRender2 | undefined = undefined;

export class GameRender2 {
...
export class GameBackgroundRender {
  ...
  constructor(render: GameRender2) {
  ...
  draw(render: GameRender2, cameraMatrix: mat4) {
    const map = useGameMap();
...
export class GamePlayerRender {
  ...
  draw(render: GameRender2, cameraMatrix: mat4, delta: number) {
    const map = useGameMap();
